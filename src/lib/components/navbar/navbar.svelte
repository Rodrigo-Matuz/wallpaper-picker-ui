...
>
    ...
    {#if showInput}
        ...
        <input
            type="text"
            class="bg-transparent shadow-none py-0.75 border-2 border-transparent border-b-transparent focus-visible:border-b-accent rounded-none outline-none focus-visible:ring-0 max-w-md text-2xl text-center leading-none caret-primary disabled:cursor-not-allowed"
